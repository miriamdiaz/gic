...
<form name="editmaterialform" method="POST" action="../catalog/materials_edit.php" enctype="multipart/form-data">
...
<table class="primary">
  ...
  <tr>
    ...
    <td valign="top" class="primary">
      <?php printInputFile("imageFile",$pageErrors); ?>
    </td>
  </tr>
  <tr>
    <td align="center" colspan="2" class="primary">
      <input type="submit" value="  <? echo $loc->getText("adminSubmit"); ?>  " class="button">
      <input type="button" onClick="parent.location='../catalog/materials_list.php'" value="  <? echo $loc->getText("adminCancel"); ?>  " class="button">
    </td>
  </tr>
