 ...
 */
  ...
  if(isset($_POST["daysDueBackcheck"]))
    $dm->setDaysDueBack(1);
 else
    $dm->setDaysDueBack(0);
  ...
  if (!$dm->validateData()) {
    ...
    header("Location: ../catalog/collections_edit_form.php");
    exit();
  }
...
<a href="../catalog/collections_list.php"><? echo $loc->getText("adminCollections_delReturn"); ?></a>
