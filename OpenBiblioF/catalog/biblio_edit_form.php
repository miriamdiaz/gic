 ...
 */
  ...
  ///echo "<H1>NO GET</H1> <br>".$postVars["literaturaFlg"]." ".$postVars["opacFlg"];
    require("../shared/get_form_vars.php");
	$bibid = $postVars["bibid"];    
	if (isset($postVars["fieldIds"]))
	{//echo "<H1>si tiene algo</H1><br>";
	//por esto duplicaba los field en la bd
	$fieldIds=$postVars["fieldIds"];
	//echo "<H1>yyyy: ".$fieldIds["020a"]."</H1>";
	}
  }
...
<input type="hidden" name="user_name_creador" value="<?php echo $postVars["user_name_creador"];?>">
