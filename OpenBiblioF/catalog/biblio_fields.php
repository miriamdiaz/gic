...
<table class="primary">
  <tr>
    <th colspan="2" valign="top" nowrap="yes" align="left">aca
      <?php
        echo $headerWording." ";
...
-->
  <?php printUsmarcInputTextWithSearch(440,"a",FALSE,$fieldIds,$postVars,$pageErrors,$marcTags, $marcSubflds, FALSE,OBIB_TEXT_CNTRL,"","coleccion");?>

<!--
Autor: Horacio Alvarez
Fecha: 28-06-06
Descripcion: Se llama a la siguiente funcion,
la cual devuelve el input field de autor
y el buscador de autores.
-->
  <?php printUsmarcInputTextWithSearch(100,"a",FALSE,$fieldIds,$postVars,$pageErrors,$marcTags, $marcSubflds, FALSE,OBIB_TEXT_CNTRL,"","autor");?>
  
  
  <?php //printUsmarcInputText(110,"a",FALSE,$fieldIds,$postVars,$pageErrors,$marcTags, $marcSubflds, FALSE,OBIB_TEXT_CNTRL);?>
  
<!--
Busqueda de Autor Corporativo.
-->
  <?php printUsmarcInputTextWithSearch(110,"a",FALSE,$fieldIds,$postVars,$pageErrors,$marcTags, $marcSubflds, FALSE,OBIB_TEXT_CNTRL,"","autor_corporativo");?>  
  
<!--
Busqueda de Responsabilidad Secundaria.
-->
  <?php printUsmarcInputTextWithSearch(245,"c",FALSE,$fieldIds,$postVars,$pageErrors,$marcTags, $marcSubflds, FALSE,OBIB_TEXT_CNTRL,"","responsibility_stmt");?>    
...
<!--
Busqueda de Lugar de edicion.
-->
  <?php printUsmarcInputTextWithSearch(260,"a",FALSE,$fieldIds,$postVars,$pageErrors,$marcTags, $marcSubflds, FALSE,OBIB_TEXT_CNTRL,"","lugar_edicion");?>      
  
  <?php //printUsmarcInputText(260,"a",FALSE,$fieldIds,$postVars,$pageErrors,$marcTags, $marcSubflds, FALSE,OBIB_TEXT_CNTRL);?>
  
<!--
Busqueda de Nombre del Editor.
-->
  <?php printUsmarcInputTextWithSearch(260,"b",FALSE,$fieldIds,$postVars,$pageErrors,$marcTags, $marcSubflds, FALSE,OBIB_TEXT_CNTRL,"","nombre_editor");?>        
  ...
  <?php // \/ MODIFICACION JUDITH 07/11/05 \/ ?>
  <?php printUsmarcInputText(504,"a",FALSE,$fieldIds,$postVars,$pageErrors,$marcTags, $marcSubflds, FALSE,OBIB_TEXT_CNTRL);?>
  <?php printUsmarcInputText(505,"a",FALSE,$fieldIds,$postVars,$pageErrors,$marcTags, $marcSubflds, FALSE,OBIB_TEXT_CNTRL);?>
  <?php // /\ MODIFICACION JUDITH 07/11/05 /\ ?>
...
<?php printUsmarcInputText(310,"a",FALSE,$fieldIds,$postVars,$pageErrors,$marcTags, $marcSubflds, FALSE,OBIB_TEXT_CNTRL);?>
 ...
 <input type="hidden" name="image_path" value="<? echo $postVars["image_path"];?>">
 <tr>
 	<td nowrap="true" class="primary" valign="top">
...
function Validar(form)
    {
    if ((form.materialCd.value == "") || (form.collectionCd.value == "") )
  		{
