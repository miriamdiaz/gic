...
?>
<a href="../catalog/collections_new_form.php?reset=Y"><? echo $loc->getText("adminCollections_listAddNewCollection"); ?></a><br>
...
<table class="primary">
  ...
  <tr>
    <td valign="top" class="<?php echo $row_class;?>">
      <a href="../catalog/collections_edit_form.php?code=<?php echo $dm->getCode();?>" class="<?php echo $row_class;?>"><? echo $loc->getText("adminCollections_listEdit"); ?></a>
    </td>
    <td valign="top" class="<?php echo $row_class;?>">
      <?php if ($dm->getCount() == 0) { ?>
        <a href="../catalog/collections_del_confirm.php?code=<?php echo $dm->getCode();?>&desc=<?php echo urlencode($dm->getDescription());?>" class="<?php echo $row_class;?>"><? echo $loc->getText("adminCollections_listDel"); ?></a>
