 ...
 */
 ...
 /*ini franco 05/07/05*/
  ...
  $postVars["create_dt"]=$biblio->getCreateDt();
  $postVars["fecha"]=$biblio->getFechaCatalog();
  $postVars["user_name_creador"]=$biblio->getUserNameCreador();
  $postVars["image_path"]=$biblio->getImage_path();
 /*fin franco*/
  ...
  $postVars["literaturaFlg"]= $biblio->getLiteraturaFlg();
