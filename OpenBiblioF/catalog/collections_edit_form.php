...
<form name="editcollectionform" method="POST" action="../catalog/collections_edit.php">
...
<table class="primary">
  ...
  <tr>
    <td nowrap="true" class="primary">
      <? echo $loc->getText("adminCollections_edit_formDaysdueback"); ?>
    </td>
    <td valign="top" class="primary">
	  <? 
  	       $checked="";
	       if($postVars["daysDueBack"]>0)
		      $checked="checked";
	       printCheckBox("daysDueBackcheck",$checked); 
	  ?>
    </td>
  </tr>
  ...
  <tr>
    <td align="center" colspan="2" class="primary">
      ...
      <input type="button" onClick="parent.location='../catalog/collections_list.php'" value="  <? echo $loc->getText("adminCancel"); ?>  " class="button">
    </td>
  </tr>
