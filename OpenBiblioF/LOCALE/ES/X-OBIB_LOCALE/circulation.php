...
$trans["indexCardHdr"]            = "\$text='Buscar socio por número de carnet:';";
$trans["indexCard"]               = "\$text='Número de D.N.I:';";
...
$trans["mbrFldsCardNmbr"]         = "\$text='Número de D.N.I:';";
...
$trans["mbrsearchCardNumber"]     = "\$text='Número de la tarjeta:';";
...
$trans["mbrViewCardNmbr"]         = "\$text='Número de D.N.I:';";
...
$trans["checkinFormEmptyCart"]    = "\$text='En la actualidad no hay bibliografías en el carrito de reposición en las estanterías.';";
...
$trans["holdMessageMsg1"]         = "\$text='La bibliografía con número de código de barras %barcode% que estás intentando conseguir tiene una o más peticiones de uso.  <b>Por favor, archiva esta bibliografía con tus artículos en uso en lugar de en el carrito de reposición en las estanterías.</b>  El código de estado de esta bibliografía ha quedado libre para su uso.';";
...
#****************************************************************************
$trans["mbrDelConfirmWarn"]       = "\$text = 'El socio, %name%, tiene %checkoutCount% préstamos y %holdCount% peticiones de uso.  Todos los materiales prestados beben ser devueltos y todas las peticiones de uso borradas antes de borrar a este socio.';";
...
#****************************************************************************
$trans["mbrHistoryHead1"]         = "\$text='Historial de préstamo del socio:';";
...
$trans["mbrPrintCheckoutsHdr3"]   = "\$text='Número de D.N.I:';";
