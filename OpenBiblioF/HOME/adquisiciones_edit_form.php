...
<form name="editcollectionform" method="POST" action="../home/adquisiciones_edit.php">
<input type="hidden" name="adqid" value="<?php echo $postVars["adqid"];?>">
<input type="hidden" name="mbrid" value="<?php echo $postVars["mbrid"];?>">
<input type="hidden" name="barcode_nmbr" value="<?php echo $barcode_nmbr;?>">
<input type="hidden" name="estado_cd" value="<?php echo $postVars["estado_cd"];?>">
<table class="primary">
  <tr>
