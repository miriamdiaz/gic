...
#****************************************************************************
$trans["biblioNewSuccess"]         = "\$text = 'Se ha creado la siguiente nueva bibliografía.  Para añadir una copia, seleccione \"Nueva copia\" del navegador de la izquierda o \"añadir nueva copia\" de la información de copia de abajo.';";
...
$trans["biblioCopyDelConfirmMsg"]  = "\$text = 'Estás seguro de que quieres borrar la copia con código de barras %barcodeNmbr%?  Esto también borrará todos los cambios en el status del historial de esta copia.';";
...
#****************************************************************************
$trans["biblioHoldListHead"]       = "\$text = 'Splicitudes de préstamo de la bibliografía:';";
$trans["biblioHoldListNoHolds"]    = "\$text = 'Actualmente no hay copias de la bibliografía en uso.';";
