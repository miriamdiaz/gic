...
<?php if ($nav == "reportlistsiunpa") { ?>
 &raquo; <?php echo $navLoc->getText("reportsReportListLinkSIUNPA");?><br>
<?php } else { ?>
<!-- <a href="../reports/report_list_siunpa.php" class="alt1">--><?php echo $navLoc->getText("reportsReportListLinkSIUNPA");?><!--</a>--><br>
<?php } ?>
<!-- /\ MODIFICACIÓN JUDITH 25/10/05 /\  -->
