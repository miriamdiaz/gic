...
<?php if ($nav == "view") { ?>
 ...
 &nbsp; &nbsp; <a href="../circ/mbr_history_sancion.php?mbrid=<?php echo $mbrid;?>" class="alt1"><?php echo $navloc->getText("checkoutSancion"); ?></a><br>
<?php } ?>

<?php if ($nav == "edit") { ?>
<!-- Linea Modificada 05-04-06: Horacio Alvarez / Se envia como parametro el RESET=Y para que borre las variables sesion-->
 &nbsp; <a href="../circ/mbr_view.php?mbrid=<?php echo $mbrid;?>&reset=Y" class="alt1"><?php echo $navloc->getText("memberInfo"); ?></a><br>
...
<?php if ($nav == "hist_sancion") { ?>
 &nbsp; <a href="../circ/mbr_view.php?mbrid=<?php echo $mbrid;?>" class="alt1"><?php echo $navloc->getText("memberInfo"); ?></a><br>
 &nbsp; &nbsp; <a href="../circ/mbr_edit_form.php?mbrid=<?php echo $mbrid;?>" class="alt1"><?php echo $navloc->getText("editInfo"); ?></a><br>
 &nbsp; &nbsp; <a href="../circ/mbr_del_confirm.php?mbrid=<?php echo $mbrid;?>" class="alt1"><?php echo $navloc->getText("catalogDelete"); ?></a><br>
 &nbsp; &nbsp; <a href="../circ/mbr_history.php?mbrid=<?php echo $mbrid;?>" class="alt1"><?php echo $navloc->getText("checkoutHistory"); ?></a><br>
 &nbsp; &nbsp; &raquo; <?php echo $navloc->getText("checkoutSancion"); ?><br>
<?php } ?>
...
<a href="javascript:popSecondary('../importador_socios.html')"><?php echo $navloc->getText("importarSocios"); ?></a>
