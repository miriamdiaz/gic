...
<?php if ($nav == "view") { ?>
 ...
 &nbsp; &nbsp; <a href="../catalog/biblio_analitica_new_form.php?bibid=<?php echo $bibid;?>&reset=Y" class="alt1"><?php echo $navLoc->getText("catalogAnaliticaNew");?></a><br>
<!-- esto va pero en otra solapa &nbsp; &nbsp; <a href="../catalog/biblio_hold_list.php?bibid=<?php echo $bibid;?>" class="alt1"><?php echo $navLoc->getText("catalogHolds");?></a><br>-->
...
<?php if ($nav == "newanalitica") { ?>
 &nbsp; <a href="../shared/biblio_view.php?bibid=<?php echo $bibid;?>" class="alt1"><?php echo $navLoc->getText("catalogBibInfo");?></a><br>
 &nbsp; &nbsp; <a href="../catalog/biblio_edit_form.php?bibid=<?php echo $bibid;?>" class="alt1"><?php echo $navLoc->getText("catalogBibEdit");?></a><br>
 &nbsp; &nbsp; <a href="../catalog/biblio_marc_list.php?bibid=<?php echo $bibid;?>" class="alt1"><?php echo $navLoc->getText("catalogBibEditMarc");?></a><br>
 &nbsp; &nbsp; <a href="../catalog/biblio_copy_new_form.php?bibid=<?php echo $bibid;?>&reset=Y" class="alt1"><?php echo $navLoc->getText("catalogCopyNew");?></a><br>
 &nbsp; &nbsp; &raquo; <?php echo $navLoc->getText("catalogAnaliticaNew");?><br>
 &nbsp; &nbsp; <a href="../catalog/biblio_hold_list.php?bibid=<?php echo $bibid;?>" class="alt1"><?php echo $navLoc->getText("catalogHolds");?></a><br>
 &nbsp; &nbsp; <a href="../catalog/biblio_del_confirm.php?bibid=<?php echo $bibid;?>" class="alt1"><?php echo $navLoc->getText("catalogDelete");?></a><br>
 &nbsp; &nbsp; <a href="../catalog/biblio_new_like.php?bibid=<?php echo $bibid;?>" class="alt1"><?php echo $navLoc->getText("catalogBibNewLike");?></a><br>
<?php } ?>

<?php if ($nav == "editanalitica") { ?>
 &nbsp; <a href="../shared/biblio_view.php?bibid=<?php echo $bibid;?>" class="alt1"><?php echo $navLoc->getText("catalogBibInfo");?></a><br>
 &nbsp; &nbsp; <a href="../catalog/biblio_edit_form.php?bibid=<?php echo $bibid;?>" class="alt1"><?php echo $navLoc->getText("catalogBibEdit");?></a><br>
 &nbsp; &nbsp; <a href="../catalog/biblio_marc_list.php?bibid=<?php echo $bibid;?>" class="alt1"><?php echo $navLoc->getText("catalogBibEditMarc");?></a><br>
 &nbsp; &nbsp; <a href="../catalog/biblio_copy_new_form.php?bibid=<?php echo $bibid;?>&reset=Y" class="alt1"><?php echo $navLoc->getText("catalogCopyNew");?></a><br>
 &nbsp; &nbsp; <a href="../catalog/biblio_analitica_new_form.php?bibid=<?php echo $bibid;?>&reset=Y" class="alt1"><?php echo $navLoc->getText("catalogAnaliticaNew");?></a><br>
 &nbsp; &nbsp; &raquo; <?php echo $navLoc->getText("catalogAnaliticaEdit");?><br>
 &nbsp; &nbsp; <a href="../catalog/biblio_hold_list.php?bibid=<?php echo $bibid;?>" class="alt1"><?php echo $navLoc->getText("catalogHolds");?></a><br>
 &nbsp; &nbsp; <a href="../catalog/biblio_del_confirm.php?bibid=<?php echo $bibid;?>" class="alt1"><?php echo $navLoc->getText("catalogDelete");?></a><br>
 &nbsp; &nbsp; <a href="../catalog/biblio_new_like.php?bibid=<?php echo $bibid;?>" class="alt1"><?php echo $navLoc->getText("catalogBibNewLike");?></a><br>
<?php } ?>
...
<?php } else { ?>
 <a href="../catalog/materials_list.php" class="alt1"><?php echo $navLoc->getText("adminMaterialTypes");?></a><br>
<?php } ?>

<?php if ($nav == "collections") { ?>
 &raquo; <?php echo $navLoc->getText("adminCollections");?><br>
<?php } else { ?>
 <a href="../catalog/collections_list.php" class="alt1"><?php echo $navLoc->getText("adminCollections");?></a><br>
<?php } ?>
<!--
fin franco
-->
<?php if ($nav == "apruebaMaterial") { ?>
 &raquo; <?php echo $navLoc->getText("catalogApruebaMaterial");?><br>
<?php } else { ?>
 <a href="../catalog/aprueba_material.php" class="alt1"><?php echo $navLoc->getText("catalogApruebaMaterial");?></a><br>
<?php } ?>
<!--
ini franco 1/08/05
-->
<?php if ($nav == "apruebaEjemplar") { ?>
 &raquo; <?php echo $navLoc->getText("catalogApruebaEjemplar");?><br>
<?php } else { ?>
 <a href="../catalog/aprueba_ejemplar.php" class="alt1"><?php echo $navLoc->getText("catalogApruebaEjemplar");?></a><br>
<?php } ?>

<?php if ($nav == "librarys") { ?>
 &raquo; <?php echo $navLoc->getText("catalogLibrary");?><br>
<?php } else { ?>
<a href="../catalog/library_list.php" class="alt1"><?php echo $navLoc->getText("catalogLibrary");?></a><br>
<?php } ?>
