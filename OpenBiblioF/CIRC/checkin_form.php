...
<form name="barcodesearch" method="POST" action="../circ/confirm_shelving_cart.php">
<table class="primary">
  <tr>
  ...
  <tr>
    <td nowrap="true" class="primary">
	  ...
	  <input type="submit" name="renovar" value="<?php echo $loc->getText("checkinFormRenovarButton"); ?>" class="button" >
    </td>
  </tr>
</table>
</form>
...
<table class="primary">
  <tr>
    <th valign="top" colspan="6" nowrap="yes" align="left">
  ...
  <tr>
    ...
    <th valign="top" nowrap="yes" align="left">
      <?php echo $loc->getText("checkinFormColHdr5"); ?>
    </th>
    <th valign="top" nowrap="yes" align="left">
      <?php echo $loc->getText("checkinFormColHdr6"); ?>
    </th>	
  </tr>
