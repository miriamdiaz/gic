...
<table class="primary">
  ...
  Fecha: 24-03-06
  Descripcion: Limite de prestamos
  -->
  <tr> 
    <td nowrap="true" class="primary"> <?php print $loc->getText("mbrFldsLimitePrestamos"); ?> 
    </td>
    <td valign="top" class="primary"> <?php printInputText("limite_prestamos",2,2,$postVars,$pageErrors,"visible",3); ?> 
    </td>
  </tr>
  <!--
  Fila agregada: Horacio Alvarez
  Fecha: 08-04-06
  Descripcion: Limite de reservas
  -->
  <tr> 
    <td nowrap="true" class="primary"> <?php print $loc->getText("mbrFldsLimiteReservas"); ?> 
    </td>
    <td valign="top" class="primary"> <?php printInputText("limite_reservas",2,2,$postVars,$pageErrors,"visible",3); ?> 
    </td>
  </tr>
  <!--
  Fila agregada: Horacio Alvarez
  ...
  <tr> 
    <td nowrap="true" class="primary"> <?php print $loc->getText("mbrFldsClassify"); ?> 
    </td>
    <td valign="top" class="primary"> <?php printSelectWithPosErrors("classification","mbr_classify_dm",$postVars,$pageErrors); ?> 
    </td>
  </tr>
  <tr> 
    <td nowrap="true" class="primary"> <?php print $loc->getText("mbrFldsCarrera"); ?> 
    </td>
    <td valign="top" class="primary"> <?php printInputText("carrera",3,3,$postVars,$pageErrors); ?> 
    </td>
  </tr>  
  <tr> 
    <td nowrap="true" class="primary"> <?php print $loc->getText("mbrFldsTipoSancion"); ?> 
    </td>
    <td valign="top" class="primary"> <?php printSelectWithPosErrors("tipo_sancion_cd","tipo_sancion_dm",$postVars,$pageErrors); ?> 
    </td>
  </tr>
  <tr> 
    <td nowrap="true" class="primary"> <?php print $loc->getText("mbrFechaSuspension"); ?> 
    </td>
    <td valign="top" class="primary"> <?php printSelectDateWithInputName("fecha_suspension",$postVars,$pageErrors); ?> 
    </td>
  </tr>      
  <tr> 
    <td nowrap="true" class="primary"> <?php print $loc->getText("mbrFechaVto"); ?> 
    </td>
    <td valign="top" class="primary"> <?php printSelectDateWithInputName("fechavto",$postVars,$pageErrors); ?> 
    </td>
  </tr>  
  <tr> 
