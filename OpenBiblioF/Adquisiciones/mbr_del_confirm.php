...
<center>
  ...
  <br><br>
  <a href="../adquisiciones/mbr_list.php?mbrid=<?php echo $mbrid;?>&reset=Y"><?php echo $loc->getText("mbrDelConfirmReturn"); ?></a>
</center>
...
?>
<center>
<form name="delbiblioform" method="POST" action="../adquisiciones/mbr_list.php?mbrid=<?php echo $mbrid;?>&reset=Y">
<?php echo $loc->getText("mbrDelConfirmMsg",array("name"=>$mbrName)); ?>
<br><br>
      <input type="button" onClick="parent.location='../adquisiciones/mbr_del.php?mbrid=<?php echo $mbrid;?>&name=<?php echo urlencode($mbrName);?>'" value="<?php echo $loc->getText("circDelete"); ?>" class="button">
