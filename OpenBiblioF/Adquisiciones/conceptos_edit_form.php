 ...
 */
  ...
  $tab = "adquisiciones";
  $nav = "conceptos";
  $focus_form_name = "editconceptoform";
  ...
  if (isset($_GET["code"])){
    ...
    $dmQ->execSelect("concepto_dm",$code);
    if ($dmQ->errorOccurred()) {
      $dmQ->close();
      displayErrorPage($dmQ);
    }
...
<form name="editcollectionform" method="POST" action="../adquisiciones/conceptos_edit.php">
<input type="hidden" name="code" value="<?php echo $postVars["code"];?>">
<table class="primary">
  <tr>
    <th colspan="2" nowrap="yes" align="left">
      <? echo "Edición de Concepto"; ?>
    </th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td valign="top" class="primary">
	  <?php printSelectDateWithInputName("fecha_vto",$postVars,$pageErrors); ?>
    </td>
  </tr>
  ...
  <tr>
    <td align="center" colspan="2" class="primary">
      ...
      <input type="button" onClick="parent.location='../adquisiciones/conceptos_list.php'" value="  <? echo "Cancelar"; ?>  " class="button">
    </td>
  </tr>
