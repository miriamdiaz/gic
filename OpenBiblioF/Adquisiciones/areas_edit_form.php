 ...
 */
  ...
  if (isset($_GET["code"])){
    ...
    $dmQ->execSelect("area_dm",$code);
    if ($dmQ->errorOccurred()) {
      $dmQ->close();
      displayErrorPage($dmQ);
    }
    $dm = $dmQ->fetchRow();
	$postVars["value"] = $dm->getValue();
...
<form name="editcollectionform" method="POST" action="../adquisiciones/areas_edit.php">
<input type="hidden" name="code" value="<?php echo $postVars["code"];?>">
<table class="primary">
  <tr>
    <th colspan="2" nowrap="yes" align="left">
      <? echo "Edición de área"; ?>
    </th>
  </tr>
  <tr>
    ...
    <td valign="top" class="primary">
      <?php printInputText("value",1,1,$postVars,$pageErrors); ?>
    </td>
  </tr>  
  <tr>
    <td nowrap="true" class="primary">
  ...
  <tr>
    <td align="center" colspan="2" class="primary">
      ...
      <input type="button" onClick="parent.location='../adquisiciones/areas_list.php'" value="  <? echo "Cancelar"; ?>  " class="button">
    </td>
  </tr>
