 ...
 */
  ...
  if (!$adq->validateData()) {
    ...
    header("Location: ../adquisiciones/adquisiciones_edit_form.php?code=".$adq->getAdqid());
    exit();
  }  
  ...
  if (!$adqQ->update($adq)) {
    ...
    displayErrorPage($adqQ);
	  ...
	  $adqQ->actualizarHistorial($adq,$_SESSION["userid"]);
...
<a href="../adquisiciones/index.php?code=<? echo $adq->getAdqid();?>&buscar=1"><? echo "Volver a Pedidos de Adquisición"; ?></a>
