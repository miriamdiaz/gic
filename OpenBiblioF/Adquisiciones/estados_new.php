 ...
 */
  ...
  if (count($_POST) == 0) {
    header("Location: ../adquisiciones/estados_new_form.php");
    exit();
  }
...
?>
<? echo "El estado : "; ?><?php echo $dm->getDescription();?><? echo " , se agregó satisfactoriamente"; ?><br><br>
