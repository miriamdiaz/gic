...
?>
<center>
<form name="delstaffform" method="POST" action="../admin/tipo_sanciones_del.php?code=<?php echo $code;?>&desc=<?php echo urlencode($description);?>">
<? echo $loc->getText("adminTipoSanciones_del_confirmText"); ?><?php echo $description;?>?<br><br>
