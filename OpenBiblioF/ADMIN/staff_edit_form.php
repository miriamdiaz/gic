 ...
 */
  ...
  if (isset($_GET["UID"])){
    ...
    if ($staff->hasAprobarAuth()) {
      $postVars["aprobar_flg"] = "CHECKED";
    } else {
      $postVars["aprobar_flg"] = "";
    }
	
    if ($staff->hasImportarAuth()) {
      $postVars["importar_flg"] = "CHECKED";
    } else {
      $postVars["importar_flg"] = "";
    }			
	
    if ($staff->hasExportarAuth()) {
      $postVars["exportar_flg"] = "CHECKED";
    } else {
      $postVars["exportar_flg"] = "";
    }		
	
    if ($staff->hasLimpiarSancion()) {
      $postVars["limpiar_sancion_flg"] = "CHECKED";
    } else {
      $postVars["limpiar_sancion_flg"] = "";
    }
	
    if ($staff->hasAdminBiblioAuth()) {
      $postVars["admin_bibliotecarios_flg"] = "CHECKED";
    } else {
      $postVars["admin_bibliotecarios_flg"] = "";
    }		
    ...
    if ($staff->hasAdquisicionesAuth()) {
      $postVars["adquisicion_flg"] = "CHECKED";
    } else {
      $postVars["adquisicion_flg"] = "";
    }	
    $staffQ->close();
  } else {
...
<table class="primary">
  ...
  <tr>
    ...
    <td valign="top" class="primary">
      ...
      <input type="checkbox" name="limpiar_sancion_flg" value="CHECKED"
        <?php if (isset($postVars["limpiar_sancion_flg"])) echo $postVars["limpiar_sancion_flg"]; ?> >
      <? echo $loc->getText("adminStaff_edit_formLimpiarSancion"); ?>
      <input type="checkbox" name="admin_bibliotecarios_flg" value="CHECKED"
        <?php if (isset($postVars["admin_bibliotecarios_flg"])) echo $postVars["admin_bibliotecarios_flg"]; ?> >
      <? echo $loc->getText("adminStaff_edit_formAdminBiblio"); ?>	  	  
      <input type="checkbox" name="aprobar_flg" value="CHECKED"
        <?php if (isset($postVars["aprobar_flg"])) echo $postVars["aprobar_flg"]; ?> >
      Aprobar
      <input type="checkbox" name="exportar_flg" value="CHECKED"
        <?php if (isset($postVars["exportar_flg"])) echo $postVars["exportar_flg"]; ?> >
      Exportar
      <input type="checkbox" name="importar_flg" value="CHECKED"
        <?php if (isset($postVars["importar_flg"])) echo $postVars["importar_flg"]; ?> >
      Importar	  	  	  
      <input type="checkbox" name="adquisicion_flg" value="CHECKED"
        <?php if (isset($postVars["adquisicion_flg"])) echo $postVars["adquisicion_flg"];?> >
      Adquisiciones
    </td>
  </tr>
  <tr>
