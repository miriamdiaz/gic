...
?>
<center>
<form name="delstaffform" method="POST" action="../admin/tipo_prestamos_del.php?code=<?php echo $code;?>&desc=<?php echo urlencode($description);?>">
<? echo $loc->getText("adminTipoPrestamos_del_confirmText"); ?><?php echo $description;?>?<br><br>
