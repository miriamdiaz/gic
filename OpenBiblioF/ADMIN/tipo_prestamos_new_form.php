 ...
 */
  ...
  $tab = "admin";
  $nav = "tipo_prestamos";
  $focus_form_name = "newtipo_prestamoform";
...
<form name="newtipo_prestamoform" method="POST" action="../admin/tipo_prestamos_new.php">
<table class="primary">
  <tr>
    <th colspan="2" nowrap="yes" align="left">
      <? echo $loc->getText("adminTipoPrestamos_new_formAddnewtipo_prestamo"); ?>
    </th>
  </tr>
  <tr>
  ...
  <tr>
    <td nowrap="true" class="primary">
      <? echo $loc->getText("adminTipoPrestamos_new_formDiasDevolucion"); ?>
    </td>
    <td valign="top" class="primary">
