 ...
 */
  ...
  $tab = "admin";
  $nav = "tipo_sanciones";
  $focus_form_name = "edittipo_sancionform";
  ...
  if (isset($_GET["code"])){
    ...
    $dmQ->execSelect("tipo_sancion_dm",$code);
    if ($dmQ->errorOccurred()) {
      $dmQ->close();
      displayErrorPage($dmQ);
    }
    ...
    $postVars["dias_sancion"] = $dm->getDias_sancion();
	$postVars["aplica_nueva_en"] = $dm->getAplica_nueva_en();
    $dmQ->close();
  } else {
...
<form name="edittipo_sancionform" method="POST" action="../admin/tipo_sanciones_edit.php">
<input type="hidden" name="code" value="<?php echo $postVars["code"];?>">
<table class="primary">
  <tr>
    <th colspan="2" nowrap="yes" align="left">
      <? echo $loc->getText("adminTipoSanciones_edit_formEditcollection"); ?>
    </th>
  </tr>
  <tr>
    <td nowrap="true" class="primary">
      <? echo $loc->getText("adminTipoSanciones_edit_formDescription"); ?>
    </td>
  ...
  <tr>
    <td nowrap="true" class="primary">
      <font class="small">*</font><? echo $loc->getText("adminTipoSanciones_edit_formDiasSancion"); ?>
    </td>
    <td valign="top" class="primary">
  ...
  <tr>
    <td nowrap="true" class="primary">
      <font class="small">*</font><? echo $loc->getText("adminTipoSanciones_edit_formAplicaNuevaEn"); ?>
    </td>
    <td valign="top" class="primary">
