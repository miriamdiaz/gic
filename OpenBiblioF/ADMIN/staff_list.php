...
<table class="primary">
  ...
  <tr>
    ...
    <td valign="top" class="<?php echo $row_class;?>">
      <?php if ($staff->hasLimpiarSancion()) {
        echo $loc->getText("adminStaff_Yes");
      } else {
        echo $loc->getText("adminStaff_No");
      } ?>
    ...
    <td valign="top" class="<?php echo $row_class;?>">
      <?php if ($staff->hasAdminBiblioAuth()) {
        echo $loc->getText("adminStaff_Yes");
      } else {
        echo $loc->getText("adminStaff_No");
      } ?>
    ...
    <td valign="top" class="<?php echo $row_class;?>">
      <?php if ($staff->hasAdquisicionesAuth()) {
        echo $loc->getText("adminStaff_Yes");
      } else {
        echo $loc->getText("adminStaff_No");
      } ?>
