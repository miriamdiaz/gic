...
?>
<? echo $loc->getText("adminStaff_Staffmember"); ?> <?php echo $staff_inserted->getFirstName();?> <?php echo $staff_inserted->getLastName();?><? echo $loc->getText("adminStaff_new_Added"); ?><br><br>
