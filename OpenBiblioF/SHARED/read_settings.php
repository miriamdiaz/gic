 ...
 */
  ...
  define("OBIB_LIBRARY_CD",$set->getLibraryCd());
  /*****************************************************************************/
  $dmQ = new DmQuery();
  $dmQ->connect();
  ...
  define("OBIB_USUARIOS_ONLINE_FLG",$set->getUsuariosOnlineFlg());
  define("OBIB_DOCENTES_ONLINE_FLG",$set->getDocentesOnlineFlg());
