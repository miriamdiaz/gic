...
if($tipo == "opac_csv")
     require_once("biblio_search_csv.php");  
elseif($tipo == "opac_html")
{
...
<table class="primary">
      ...
      if ($biblio->getBibid() == $priorBibid) {
        if ($biblio->getBarcodeNmbr() != "") {
          ...
          <tr>
            ...
            <td class="primary" ><font class="small"><b><?php echo $loc->getText("biblioSearchCopyStatus"); ?></b>: 
			<?php 	
  ...
  <tr>
    <td nowrap="true" class="primary" valign="top" align="center" rowspan="2">
	  ...
	  <img src="../fotos/foto_tipo_material.php?code=<? echo $biblio->getMaterialCd();?>" width="20" height="20" border="0">
    </td>
    <td class="primary" valign="top" colspan="2">
      <table class="primary" width="100%">
		...
		<!-- \/ judith 16-02-06 -->
        <tr>
          <td class="noborder" valign="top"><b><?php echo $loc->getText("biblioSearchResponsibility_Stmt"); ?>:</b></td>
          <td class="noborder" colspan="3"><?php if ($biblio->getResponsibilityStmt() != "") echo $biblio->getResponsibilityStmt();?></td>
		</tr>
		<!-- /\                 -->
		<tr>
	...
	<td class="primary">
<!--	<img src="../fotos/foto.php?bibid=<?=$biblio->getBibid();?>" width="60" height="90">-->
	<!--
	...
	--->
    <img src="../fotos/foto.php?bibid=<?=$priorBibid?>" width="70" height="90">
	</td>
  </tr>
  <?php
    if ($biblio->getBarcodeNmbr() != "") {
      ...
      <tr>
        ...
        <td class="primary" >
		<font class="small"><b><?php echo $loc->getText("biblioSearchCopyStatus"); ?></b>: 
		<?php 
		$holdQ=new BiblioHoldQuery();
	    $holdQ->connect();
	    $hold=$holdQ->getFirstHold($biblio->getBibid(),$biblio->getCopyid());
