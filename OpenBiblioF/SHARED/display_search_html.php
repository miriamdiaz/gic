...
-->
<h><a href="#" onClick="history.back()"><?php echo $loc->getText("volverBusquedaAvanzada"); ?></a></h>
...
<table class="primary">
  ...
  <?php
    ...
    $reportQ->close();
  ?>
  <tr><th class="rpt" colspan="<?php echo $colCount;?>">Coincidencias: <?php echo $rowCount;?></th></tr>
</table>
<br>
<!--
<font class="small">
