...
<?php
  foreach ($reportids as $rptid) {
	...
	if($rptid=="prestamosAnuales")
	    echo "<li><a href=\"../reports/report_criteria_prestamos_anuales.php?reset=Y&rptid=".$rptid."&title=".$title."&sql=".$sql."\">".$rptTitle."</a></li>";
	elseif($rptid=="prestamosMensuales")
	    echo "<li><a href=\"../reports/report_criteria_prestamos_mensuales.php?reset=Y&rptid=".$rptid."&title=".$title."&sql=".$sql."\">".$rptTitle."</a></li>";
	elseif($rptid=="listadoSocios")
	    echo "<li><a href=\"../reports/report_criteria_socios.php?reset=Y&rptid=".$rptid."&title=".$title."&sql=".$sql."\">".$rptTitle."</a></li>";		
	elseif($rptid=="prestamosDiarios")
	    echo "<li><a href=\"../reports/report_criteria_prestamos_diarios.php?reset=Y&rptid=".$rptid."&title=".$title."&sql=".$sql."\">".$rptTitle."</a></li>";
	elseif($rptid=="devolucionesDiarias")
	    echo "<li><a href=\"../reports/report_criteria_devoluciones_diarias.php?reset=Y&rptid=".$rptid."&title=".$title."&sql=".$sql."\">".$rptTitle."</a></li>";		
	elseif($rptid=="prestamosVencer")
	    echo "<li><a href=\"../reports/report_criteria_prestamos_vencer.php?reset=Y&rptid=".$rptid."&title=".$title."&sql=".$sql."\">".$rptTitle."</a></li>";				
	elseif($rptid=="siunpaEstadisctico")
	   {
	    $_SESSION["sqlSiunpa"] = $originalSql;
       // echo "<li><a href=\"../reports/report_criteria_estadistico_siunpa.php?reset=Y&rptid=".$rptid."&title=".$title."\">".$rptTitle."</a></li>";		
	   }
	elseif($rptid == "estadisticoOperaciones")
	   {
	    $_SESSION["sqlOperaciones"] = $originalSql;
        echo "<li><a href=\"../reports/report_criteria_estadistico_operaciones.php?reset=Y&rptid=".$rptid."&title=".$title."\">".$rptTitle."</a></li>";		
	   }
	elseif($rptid == "estadisticoUsuarios")
	   {
	    $_SESSION["sqlUsuarios"] = $originalSql;
        echo "<li><a href=\"../reports/report_criteria_estadistico_usuarios.php?reset=Y&rptid=".$rptid."&title=".$title."\">".$rptTitle."</a></li>";		
	   }
