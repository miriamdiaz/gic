...
<table class="primary">
  ...
  <tr>
    ...
    <td class="primary" align="left" valign="top" nowrap="yes">
		...
		$letra_desde = "";
		$letra_hasta = "";
		if(isset($postVars["letra_desde"]))
		   $letra_desde = $postVars["letra_desde"];
		if(isset($postVars["letra_hasta"]))
		   $letra_hasta = $postVars["letra_hasta"];
		?>	
		Desde<?php printAlfabeto("letra_desde",$letra_desde);?>
		Hasta<?php printAlfabeto("letra_hasta",$letra_hasta);?>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class="primary" align="left" valign="top" nowrap="yes">
		<?php printSelectCarreras("carrera",$postVars);?>
    </td>
  </tr>  
