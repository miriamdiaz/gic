...
#****************************************************************************
 ...
 #****************************************************************************
  ...
  require_once("../classes/ReportBibliosCopysQuery.php");
  ...
  $biblioQ = new ReportBibliosCopysQuery();
  //echo "new";
  ...
  if ($tab == "opac") {
   ...
   if (!$biblioQ->viewBibliosCopys($currentPageNmbr)) 
  {
    $biblioQ->close();
    displayErrorPage($biblioQ);
  }
...
<!--**************************************************************************
    ...
    ************************************************************************** -->
<form name="changePageForm" method="POST" action="../reports/list_biblios_copys_form.php">
...
<!--**************************************************************************
    ...
    ************************************************************************** -->
<h1><?php print $loc->getText("reportSiunpaHead4"); ?></h1>
