...
<!--**************************************************************************
    ...
    ************************************************************************** -->
<form name="changePageForm" method="POST" action="../reports/display_report_copys_html.php">
...
<!--**************************************************************************
    ...
    ************************************************************************** -->
<h1><?php print $loc->getText("reportSiunpaHead2"); ?></h1>

<font class="small">
<a href="../reports/list_new_biblios_form.php"><?php print $loc->getText("runReportListReturnLink1"); ?></a>
    ...
    while ($biblio = $biblioQ->fetchRowFranco()) 
    {
      $priorBibid = $biblio->getBibid();
	    ...
	    <tr>
			...
			<td class="primary" valign="center" align="center">
             <?php echo $biblio->getPrecio(); ?>
        	</td>
			<td class="primary" valign="center" align="center">
             <?php getLocaliz($biblio->getCodLoc()); ?>
        	</td>
			<td class="primary" valign="center" align="center">
             <?php echo $biblio->getStatusBeginDt(); ?>
        	</td>
			<td class="primary" valign="center" align="center">
             <?php getName($biblio->getUserCreador()); ?>
        	</td>
		</tr>
    <?php 
    }
