...
<!--**************************************************************************
    ...
    ************************************************************************** -->
<form name="changePageForm" method="POST" action="../reports/display_report_biblios_html.php">
...
<!--**************************************************************************
    ...
    ************************************************************************** -->
<h1><?php print $loc->getText("reportSiunpaHead1"); ?></h1>
    ...
    while ($biblio = $biblioQ->fetchRowFranco()) 
    {
	  ...
	  else 
      {
	    ...
	    <tr>
			...
			<td class="primary" valign="center" align="center">
             <?php getName($biblio->getUserNameCreador()); ?>
        	</td>
		</tr>
    <?php 
    }
