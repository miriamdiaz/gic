...
class Staff {
  ...
  function validatePwd() {
    ...
    if (strlen($this->_pwd) < 4) {
      $valid = false;
      $this->_pwdError = "La contraseña debe contener al menos 4 caracteres.";
    } elseif (substr_count($this->_pwd, " ") > 0) {
      $valid = false;
      $this->_pwdError = "La contraseña no debe contener espacios.";
    } elseif ($this->_pwd != $this->_pwd2) {
      $valid = false;
      $this->_pwdError = "Las contraseñas no coinciden.";
    }
    return $valid;
  }
