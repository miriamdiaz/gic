...
class BiblioStatusHistQuery extends Query {
  ...
  function queryByMbridAndSanciono($mbrid) {
    # setting query that will return all the data
    $sql = $this->mkSQL("select biblio_status_hist.*, "
                        . " biblio.title, biblio.author, "
                        . " biblio_copy.barcode_nmbr biblio_barcode_nmbr, "
                        ...
                        . " and biblio_status_hist.copyid = biblio_copy.copyid "
                        . " and biblio_status_hist.mbrid = member.mbrid "
                        . " and biblio_status_hist.mbrid = %N and biblio_status_hist.sanciono = 's' "
                        . "order by status_begin_dt desc ",
                        $mbrid);
  ...
  function queryByMbridAndStatus($mbrid,$status_cd) {
    # setting query that will return all the data
    $sql = $this->mkSQL("select biblio_status_hist.*, "
                        . " biblio.title, biblio.author, "
                        . " biblio_copy.barcode_nmbr biblio_barcode_nmbr, "
                        ...
                        . " and biblio_status_hist.copyid = biblio_copy.copyid "
                        . " and biblio_status_hist.mbrid = member.mbrid "
                        . " and biblio_status_hist.mbrid = %N and biblio_status_hist.status_cd = %Q "
                        . "order by status_begin_dt desc ",
                        $mbrid, $status_cd);
  ...
  function fetchRow() {
	...
	$hist->setSanciono($array["sanciono"]);
	//agregado: Horacio Alvarez
	$hist->setUserId($array["userid"]);
    return $hist;
  }
  ...
  function insert($hist) {
    $sql = $this->mkSQL("insert into biblio_status_hist values "
                        ...
                        $hist->getStatusCd(),$hist->getUserId());
	...
	$sql .= $this->mkSQL("%Q)", $hist->getSanciono());
