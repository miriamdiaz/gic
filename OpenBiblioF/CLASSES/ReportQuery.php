...
class ReportQuery extends Query {
  ...
  function ReportQuery () {
    $this->_loc = new Localize("es","classes");
  }
  ...
  Fecha: 01-04-06
  Descripcion: Linea agregada en caso de que en el XML de definicion del reporte se 
  encuentre la constante {validate_date} la reemplaze por un string con codigo SQL. 
  */
    $sql = str_replace("{validate_date}","and biblio_copy.due_back_dt < CURRENT_DATE",$sql);  	
