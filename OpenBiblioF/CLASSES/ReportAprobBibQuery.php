 ...
 ******************************************************************************
 */
class ReportAprobBibQuery extends Query {
  var $_rowCount = 0;
  var $_loc;
  var $_itemsPerPage = 1;
  var $_rowNmbr = 0;
 ...
 function viewBibliosAprob($page,$fecha1,$fecha2)
	{
    	...
    	$sqlcount = "SELECT count(*) as rowcount " 
		           . "FROM biblio, auditoria " 
				   . "WHERE biblio.aprob_flg = 1 "
				   . "AND biblio.bibid = auditoria.bibid "
				   . "AND auditoria.nombretabla = \"biblio\" "
				   . "AND auditoria.operacion = 4 "
				   . "AND auditoria.fecha >= '$fecha1' "
				   . "AND auditoria.fecha <= '$fecha2' ";
	    ...
	    $sql = $this->mkSQL("SELECT biblio.*, auditoria.userid, auditoria.fecha "
		                  . "FROM biblio, auditoria "
						  . "WHERE biblio.aprob_flg = 1 "
						  . "AND biblio.bibid = auditoria.bibid "
